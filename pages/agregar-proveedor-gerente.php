...
<body>
    ...
    <main class="container mt-5">
        <button><a href="gerente.php">Volver al panel de Gerencia</a></button>
        ...
        <form class="bg-white p-4 rounded" action="procesar_producto.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" id="nombreProducto" name="nombreProducto" class="form-control" placeholder="Nombre del proveedor" required>
            </div>

            <div class="mb-3">
                <label for="nombreProducto" class="form-label">CUIT del Proveedor</label>
                <input type="text" id="nombreProducto" name="nombreProducto" class="form-control" placeholder="CUIT del proveedor" required>
            </div>

            <div class="mb-3">
                <label for="nombreProducto" class="form-label">Telefono</label>
                <input type="text" id="nombreProducto" name="nombreProducto" class="form-control" placeholder="Telefono del proveedor" required>
            </div>

            <div class="mb-3">
                <label for="nombreProducto" class="form-label">Correo Electronico</label>
                <input type="text" id="nombreProducto" name="nombreProducto" class="form-control" placeholder="Correo del proveedor" required>
            </div>


            <!-- Nueva sección para el punto de reposición -->
            <div class="mb-3">
                <label for="reposicion" class="form-label">Ubicación en el mapa</label>
                <div class="input-group">
                    <input type="text" id="reposicion" name="reposicion" class="form-control" placeholder="Selecciona un punto en el mapa" readonly required>
