...
<body>
    <header>
        <div class="container">
            ...
            <nav>
                ...
                <a href="carrito.php" class="text-dark ms-3 carrito">
    ...
    <main class="container mt-5">
        ...
        <div class="d-flex justify-content-center mt-4">
            ...
            <aside class="filters bg-white p-4 rounded me-4" style="width: 200px;">
                <h2>Filtros</h2>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="range" id="price" class="form-range" min="0" max="500" step="10">
                    <span id="price-value">Hasta $500</span>
                </div>
                ...
                <button id="apply-filters" class="btn btn-warning w-100">Aplicar Filtros</button>
            </aside>

        <!-- Productos a la derecha -->
        <section class="product-list">
            <!-- Aquí irán las tarjetas de los productos -->
            <div class="product-card" data-category="calzado">
                <a href="detalle-producto.php">
                    <img src="/AndeSportFinal/AndeSportFinal/SitioWeb_AndeSport-FINALDEFINITIVO4.0ULTRA/img/calzado1.jpg" alt="Producto 1">
                    <h3>Zapatillas Trekking</h3>
                    <p>$120</p>
                    <button>Añadir al carrito</button>
                </a>
            </div>
            <div class="product-card" data-category="calzado">
                <img src="/AndeSportFinal/AndeSportFinal/SitioWeb_AndeSport-FINALDEFINITIVO4.0ULTRA/img/calzado2.jpg" alt="Producto 2">
                <h3>Zapatillas Trekking</h3>
                <p>$200</p>
                <button>Añadir al carrito</button>
            </div>
            <div class="product-card" data-category="calzado">
                <img src="/AndeSportFinal/AndeSportFinal/SitioWeb_AndeSport-FINALDEFINITIVO4.0ULTRA/img/calzado3.jpg" alt="Producto 3">
                <h3>Zapatillas Trekking</h3>
                <p>$200</p>
                <button>Añadir al carrito</button>
            </div>
